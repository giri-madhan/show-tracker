...
exports.handler = async (event) => {
    ...
    const {_id:id, name, rating, genre, releaseDate, watchDate, duration, watchCount, prodCompany, photo, notes} = JSON.parse(event.body)
    const variables = {id, name, rating, genre, releaseDate, watchDate, duration, watchCount, prodCompany, photo, notes}
    try {
